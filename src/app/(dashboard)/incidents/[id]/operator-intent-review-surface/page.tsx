...
export default async function OperatorIntentReviewSurfacePage(props: PageProps) {
  ...
  let status: ReviewStatus = "OPERATOR_INTENT_REVIEW_CONFIG_MISSING";
  ...
  const payload = {
    ...
    persisted_draft_found: found,
    current_intent_status: intentStatus,
  ...
  return (
    <main className="mx-auto flex w-full max-w-5xl flex-col gap-8 px-4 py-8 text-white sm:px-6 lg:px-8">
      <Card tone={found ? "green" : "amber"}>
        <Eyebrow>Operator Intent Review Surface</Eyebrow>

        <h1 className="max-w-4xl text-5xl font-black leading-[0.95] tracking-[-0.06em] sm:text-7xl">
          Revue d’intention opérateur
        </h1>

        <p className="mt-8 max-w-3xl text-xl leading-10 text-white/60">
          V5.9 affiche l’intention Draft persistée en V5.8 pour revue opérateur.
          Cette surface ne valide rien, ne crée aucune Command, ne crée aucun Run
          et n’appelle aucun worker.
        </p>
      ...
      <Card tone="green">
        ...
        <div className="grid gap-4">
          <DataTile label="Previous Version" value="Incident Detail V5.8" tone="green" />
          <DataTile
            label="Previous Status"
            value="INTENT_PERSISTED_AS_DRAFT"
            tone="green"
          />
          <DataTile label="Persistence Policy" value="DRAFT_ONLY" tone="cyan" />
          <DataTile label="Command Creation" value="DISABLED" tone="red" />
        </div>
      </Card>

      <Card tone={found ? "green" : "amber"}>
        <Eyebrow>Persisted Intent Snapshot</Eyebrow>

        <div className="grid gap-4">
          <DataTile
            label="Draft Found"
            value={found ? "YES" : "NO"}
            tone={found ? "green" : "amber"}
          />
          ...
          <DataTile label="Current Status" value={intentStatus} tone="amber" />
      ...
      <Card tone="amber">
        <Eyebrow>Operator Review Gate</Eyebrow>

        <div className="grid gap-4">
          <DataTile label="Operator Review" value="READ_ONLY" tone="cyan" />
          <DataTile label="Operator Approval" value="NOT_CAPTURED" tone="amber" />
          <DataTile
            label="Approval Capture"
            value="DISABLED_IN_V5_9"
            tone="red"
          />
          <DataTile
            label="Next Transition"
            value="BLOCKED_UNTIL_OPERATOR_APPROVAL_LAYER"
            tone="amber"
          />
        </div>
      </Card>
      ...
      <Card tone="red">
        <Eyebrow>Command Creation Lock</Eyebrow>
        ...
        <div className="flex flex-wrap gap-3">
          ...
          <Badge tone="cyan">REVIEW ONLY</Badge>
          <Badge tone="amber">OPERATOR APPROVAL REQUIRED</Badge>
        </div>
        ...
        >
          Validation opérateur future non activée
        </button>
      </Card>

      <Card tone="cyan">
        <Eyebrow>Future Command Requirements</Eyebrow>
      ...
      <Card>
        <Eyebrow>Read-only Review Payload</Eyebrow>
