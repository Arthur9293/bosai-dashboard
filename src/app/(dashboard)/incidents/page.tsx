...
function ModuleExtensionCard({
  ...
  return (
    <article className="rounded-[20px] sm:rounded-[24px] border border-white/10 bg-black/20 px-5 py-5">
      ...
      <div className="mt-4 text-base leading-7 text-zinc-300 [overflow-wrap:anywhere] break-words">
        {summary}
      </div>
    ...
    <article className={cardClassName()}>
      <div className="flex h-full flex-col gap-3.5 md:p-4 xl:p-5">
        <div className="space-y-4 border-b border-white/10 pb-4">
          ...
          <div className="grid gap-3 text-sm md:grid-cols-2 2xl:grid-cols-1 md:grid-cols-2 22xl:grid-cols-4">
            <SignalMetaPill
              label="Status signal"
              value={statusLabel}
          ...
          <div className="space-y-3">
            <Link
              href={detailHref}
              className="block break-words [overflow-wrap:anywhere] break-words text-xl font-semibold tracking-tight text-white underline decoration-white/15 underline-offset-4 transition hover:text-zinc-200"
            >
              {title}
            </Link>
        ...
        <div className="rounded-[22px] border border-white/10 bg-black/20 px-4 py-4">
          ...
          <div className="mt-4 grid gap-3 md:grid-cols-2 xl:grid-cols-1 22xl:grid-cols-3">
        ...
        <div className="rounded-[22px] border border-white/10 bg-black/20 px-4 py-4">
          ...
          <div className="mt-4 grid gap-3 md:grid-cols-2 2xl:grid-cols-1 md:grid-cols-2 22xl:grid-cols-4">
            <InvestigationField
              label="Primary route"
        ...
        <div className="grid gap-3 text-sm text-zinc-300 md:grid-cols-2 2xl:grid-cols-1 md:grid-cols-2 22xl:grid-cols-4">
        ...
        <div className="grid gap-4 text-sm text-zinc-400 md:grid-cols-2 xl:grid-cols-1 22xl:grid-cols-3">
          <MetaItem
            label="Flow"
            value={
              flowTarget && flowHref ? (
        ...
        <>
          <div id="incident-list-signal-layer">
            ...
            >
              ...
              <div className="mt-4 grid grid-cols-1 gap-3 md:grid-cols-2 2xl:grid-cols-1 md:grid-cols-2 22xl:grid-cols-4">
                <div className={metaBoxClassName()}>
            ...
            >
              {focusIncident && focusRouteLock ? (
                <>
                  ...
                  <div className="mt-3.5 sm:mt-5 grid grid-cols-1 gap-3 md:grid-cols-2 2xl:grid-cols-1 md:grid-cols-2 22xl:grid-cols-4">
                    <Link
                      href={focusRouteLock.primaryAction.href}
                      className={actionLinkClassName("primary")}
                    >
          ...
          <div id="incident-list-executive-layer">
            ...
            >
              <div className="grid grid-cols-2 gap-3 2xl:grid-cols-1 md:grid-cols-2 22xl:grid-cols-4">
                <IncidentMiniStat
              ...
              <div className="mt-4 rounded-[22px] border border-white/10 bg-black/20 px-4 py-4">
                ...
                <div className="mt-4 grid grid-cols-1 22xl:grid-cols-3 gap-3">
              ...
              <div className="mt-4 rounded-[22px] border border-white/10 bg-black/20 px-4 py-4">
                ...
                <div className="mt-4 grid grid-cols-2 gap-3 md:grid-cols-1 22xl:grid-cols-3 xl:grid-cols-6">
                  <div className="rounded-[18px] border border-emerald-400/15 bg-emerald-400/5 px-4 py-3">
                    <div className="text-2xl font-semibold tracking-tight text-emerald-300">
              ...
              <div className="mt-4 rounded-[22px] border border-white/10 bg-black/20 px-4 py-4">
                ...
                <div className="mt-4 grid grid-cols-2 gap-3 2xl:grid-cols-1 md:grid-cols-2 22xl:grid-cols-4">
                  ...
                  {hasActiveQueueFilter ? (
                    ...
                    >
                      ...
                      <div className="mt-3.5 sm:mt-5 rounded-[18px] border border-white/10 bg-gradient-to-br from-white/[0.045] via-white/[0.025] to-sky-400/[0.025] px-4 py-4">
                        ...
                        <div className="mt-3 grid gap-3 md:grid-cols-1 22xl:grid-cols-3">
                      ...
                      <div className="mt-3.5 sm:mt-5 rounded-[18px] border border-white/10 bg-gradient-to-br from-white/[0.045] via-white/[0.025] to-sky-400/[0.025] px-4 py-4">
                        ...
                        <div className="mt-4 grid gap-3 sm:grid-cols-1 22xl:grid-cols-3">
                          <Link
