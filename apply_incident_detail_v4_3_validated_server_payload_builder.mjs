...
type ValidatedDryRunPayload = {
  ...
  dry_run: true;
  source: "dashboard_incident_detail_v4_3";
};
...
function collectIgnoredDangerousFields(body: JsonRecord): string[] {
  ...
  return dangerousKeys.filter((key) => Object.prototype.hasOwnProperty.call(body, key));
}
...
export async function POST(
    ...
    return jsonResponse(
      {
        ...
        version: "Incident Detail V4.3",
        source: "dashboard_incident_detail_v4_3_payload_builder",
        guardrails: {
    ...
    return jsonResponse(
      {
        ...
        incident_id: null,
        message: "Incident id is required for dry run payload preparation.",
        version: "Incident Detail V4.3",
        source: "dashboard_incident_detail_v4_3_payload_builder",
        guardrails: {
          worker_call: "DISABLED",
    ...
    return jsonResponse(
      {
        ...
        workspace_id: null,
        message: "Workspace id is required for dry run payload preparation.",
        version: "Incident Detail V4.3",
        source: "dashboard_incident_detail_v4_3_payload_builder",
        validation: {
          incident_id: "OK",
  ...
  const payloadReadiness =
    commandId || flowId ? "PAYLOAD_READY_WITH_EXECUTION_CONTEXT" : "PAYLOAD_READY_INCIDENT_CONTEXT_ONLY";
  ...
  return jsonResponse(
    {
      ...
      message: "Validated server payload prepared. Worker call is not implemented yet.",
      version: "Incident Detail V4.3",
      source: "dashboard_incident_detail_v4_3_payload_builder",
      ...
      server_contract: {
        ...
        mode: "PAYLOAD_BUILDER_ONLY",
        next_step: "V4.4 will prepare worker request envelope without calling the worker.",
      },
      guardrails: {
        worker_call: "DISABLED",
        post_run: "DISABLED",
